INSERT INTO projects (
    external_id, customer_name, project_name, project_status, security_budget, solution, purchased_products, track,
    industry, sub_industry, scenario, key_risks, key_needs, custom_fields,
    deleted, created_at, updated_at
)
SELECT 'DEMO-001', '华东示例银行', '数据安全治理一期', '机会点识别', 500.00, '安全咨询', JSON_ARRAY(), '数据安全',
...
SELECT 'DEMO-002', '滨海市政务云', '云安全运营平台', '机会点识别', 800.00, '运营服务', JSON_ARRAY(), '云安全',
...
SELECT '项目综合宽表', 'combined',
       JSON_ARRAY(
           ...
           JSON_OBJECT('key', 'industry', 'title', '行业'),
           JSON_OBJECT('key', 'product.AAD', 'title', 'AAD'),
           JSON_OBJECT('key', 'product.WAF', 'title', 'WAF'),
           JSON_OBJECT('key', 'product.CFW', 'title', 'CFW'),
           JSON_OBJECT('key', 'product.ESA', 'title', 'ESA'),
           JSON_OBJECT('key', 'product.HSS', 'title', 'HSS'),
           JSON_OBJECT('key', 'product.NDR', 'title', 'NDR'),
           JSON_OBJECT('key', 'product.DEW', 'title', 'DEW'),
           JSON_OBJECT('key', 'product.DSC', 'title', 'DSC'),
           JSON_OBJECT('key', 'product.SecMaster', 'title', 'SecMaster'),
           JSON_OBJECT('key', 'product.DBSS', 'title', 'DBSS'),
           JSON_OBJECT('key', 'product.CBH', 'title', 'CBH'),
           JSON_OBJECT('key', 'product.安全运营专业服务', 'title', '安全运营专业服务'),
           JSON_OBJECT('key', 'product.大模型防火墙', 'title', '大模型防火墙'),
           JSON_OBJECT('key', 'product.智能体卫士', 'title', '智能体卫士'),
